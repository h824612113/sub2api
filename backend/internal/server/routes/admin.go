...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.GET("/auto-probe/settings", h.Admin.Account.GetAccountAutoProbeSettings)
		accounts.PUT("/auto-probe/settings", h.Admin.Account.UpdateAccountAutoProbeSettings)
