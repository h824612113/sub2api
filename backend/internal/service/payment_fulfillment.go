...
func (s *PaymentService) doSub(ctx context.Context, o *dbent.PaymentOrder) error {
	...
	if _, err = s.subscriptionSvc.AssignOrExtendSubscriptionBundle(ctx, &AssignSubscriptionInput{UserID: o.UserID, GroupID: gid, ValidityDays: days, AssignedBy: 0, Notes: orderNote}); err != nil {
